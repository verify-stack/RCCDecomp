...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.17 2025-03-10 01:06:10 GMT")
...
{	switch (p->type)
	...
	case SOAP_TYPE_ns1__ScriptExecution:
		if (p->size < 0)
			SOAP_DELETE((ns1__ScriptExecution*)p->ptr);
		else
			SOAP_DELETE_ARRAY((ns1__ScriptExecution*)p->ptr);
		break;
	case SOAP_TYPE_ns1__ArrayOfLuaValue:
		if (p->size < 0)
			SOAP_DELETE((ns1__ArrayOfLuaValue*)p->ptr);
		else
			SOAP_DELETE_ARRAY((ns1__ArrayOfLuaValue*)p->ptr);
		break;
	case SOAP_TYPE_ns1__ArrayOfJob:
		if (p->size < 0)
			SOAP_DELETE((ns1__ArrayOfJob*)p->ptr);
		else
			SOAP_DELETE_ARRAY((ns1__ArrayOfJob*)p->ptr);
		break;
	case SOAP_TYPE_ns1__LuaValue:
		if (p->size < 0)
			SOAP_DELETE((ns1__LuaValue*)p->ptr);
		else
			SOAP_DELETE_ARRAY((ns1__LuaValue*)p->ptr);
		break;
	case SOAP_TYPE__ns1__HelloWorld:
		if (p->size < 0)
	...
	case SOAP_TYPE__ns1__GetStatus:
		if (p->size < 0)
			SOAP_DELETE((_ns1__GetStatus*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__GetStatus*)p->ptr);
		break;
	case SOAP_TYPE__ns1__GetStatusResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__GetStatusResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__GetStatusResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__OpenJob:
		if (p->size < 0)
			SOAP_DELETE((_ns1__OpenJob*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__OpenJob*)p->ptr);
		break;
	case SOAP_TYPE__ns1__OpenJobEx:
		if (p->size < 0)
			SOAP_DELETE((_ns1__OpenJobEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__OpenJobEx*)p->ptr);
		break;
	case SOAP_TYPE__ns1__OpenJobResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__OpenJobResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__OpenJobResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__OpenJobExResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__OpenJobExResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__OpenJobExResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__RenewLease:
		if (p->size < 0)
			SOAP_DELETE((_ns1__RenewLease*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__RenewLease*)p->ptr);
		break;
	case SOAP_TYPE__ns1__RenewLeaseResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__RenewLeaseResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__RenewLeaseResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__Execute:
		if (p->size < 0)
	...
	case SOAP_TYPE__ns1__ExecuteEx:
		if (p->size < 0)
			SOAP_DELETE((_ns1__ExecuteEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__ExecuteEx*)p->ptr);
		break;
	case SOAP_TYPE__ns1__ExecuteExResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__ExecuteExResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__ExecuteExResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__CloseJob:
		if (p->size < 0)
			SOAP_DELETE((_ns1__CloseJob*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__CloseJob*)p->ptr);
		break;
	case SOAP_TYPE__ns1__CloseJobResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__CloseJobResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__CloseJobResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__BatchJob:
		if (p->size < 0)
			SOAP_DELETE((_ns1__BatchJob*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__BatchJob*)p->ptr);
		break;
	case SOAP_TYPE__ns1__BatchJobResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__BatchJobResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__BatchJobResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__BatchJobEx:
		if (p->size < 0)
			SOAP_DELETE((_ns1__BatchJobEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__BatchJobEx*)p->ptr);
		break;
	case SOAP_TYPE__ns1__BatchJobExResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__BatchJobExResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__BatchJobExResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__GetExpiration:
		if (p->size < 0)
			SOAP_DELETE((_ns1__GetExpiration*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__GetExpiration*)p->ptr);
		break;
	case SOAP_TYPE__ns1__GetExpirationResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__GetExpirationResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__GetExpirationResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__GetAllJobs:
		if (p->size < 0)
			SOAP_DELETE((_ns1__GetAllJobs*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__GetAllJobs*)p->ptr);
		break;
	case SOAP_TYPE__ns1__GetAllJobsResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__GetAllJobsResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__GetAllJobsResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__GetAllJobsEx:
		if (p->size < 0)
			SOAP_DELETE((_ns1__GetAllJobsEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__GetAllJobsEx*)p->ptr);
		break;
	case SOAP_TYPE__ns1__GetAllJobsExResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__GetAllJobsExResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__GetAllJobsExResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__CloseExpiredJobs:
		if (p->size < 0)
			SOAP_DELETE((_ns1__CloseExpiredJobs*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__CloseExpiredJobs*)p->ptr);
		break;
	case SOAP_TYPE__ns1__CloseExpiredJobsResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__CloseExpiredJobsResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__CloseExpiredJobsResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__CloseAllJobs:
		if (p->size < 0)
			SOAP_DELETE((_ns1__CloseAllJobs*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__CloseAllJobs*)p->ptr);
		break;
	case SOAP_TYPE__ns1__CloseAllJobsResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__CloseAllJobsResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__CloseAllJobsResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__Diag:
		if (p->size < 0)
			SOAP_DELETE((_ns1__Diag*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__Diag*)p->ptr);
		break;
	case SOAP_TYPE__ns1__DiagResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__DiagResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__DiagResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__DiagEx:
		if (p->size < 0)
			SOAP_DELETE((_ns1__DiagEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__DiagEx*)p->ptr);
		break;
	case SOAP_TYPE__ns1__DiagExResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__DiagExResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__DiagExResponse*)p->ptr);
		break;
	case SOAP_TYPE___ns2__HelloWorld:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__HelloWorld*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__HelloWorld*)p->ptr);
		break;
	case SOAP_TYPE___ns2__GetVersion:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__GetVersion*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__GetVersion*)p->ptr);
		break;
	case SOAP_TYPE___ns2__GetStatus:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__GetStatus*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__GetStatus*)p->ptr);
		break;
	case SOAP_TYPE___ns2__OpenJob:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__OpenJob*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__OpenJob*)p->ptr);
		break;
	case SOAP_TYPE___ns2__OpenJobEx:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__OpenJobEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__OpenJobEx*)p->ptr);
		break;
	case SOAP_TYPE___ns2__RenewLease:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__RenewLease*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__RenewLease*)p->ptr);
		break;
	case SOAP_TYPE___ns2__Execute:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__Execute*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__Execute*)p->ptr);
		break;
	case SOAP_TYPE___ns2__ExecuteEx:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__ExecuteEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__ExecuteEx*)p->ptr);
		break;
	case SOAP_TYPE___ns2__CloseJob:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__CloseJob*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__CloseJob*)p->ptr);
		break;
	case SOAP_TYPE___ns2__BatchJob:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__BatchJob*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__BatchJob*)p->ptr);
		break;
	case SOAP_TYPE___ns2__BatchJobEx:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__BatchJobEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__BatchJobEx*)p->ptr);
		break;
	case SOAP_TYPE___ns2__GetExpiration:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__GetExpiration*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__GetExpiration*)p->ptr);
		break;
	case SOAP_TYPE___ns2__GetAllJobs:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__GetAllJobs*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__GetAllJobs*)p->ptr);
		break;
	case SOAP_TYPE___ns2__GetAllJobsEx:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__GetAllJobsEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__GetAllJobsEx*)p->ptr);
		break;
	case SOAP_TYPE___ns2__CloseExpiredJobs:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__CloseExpiredJobs*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__CloseExpiredJobs*)p->ptr);
		break;
	case SOAP_TYPE___ns2__CloseAllJobs:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__CloseAllJobs*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__CloseAllJobs*)p->ptr);
		break;
	case SOAP_TYPE___ns2__Diag:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__Diag*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__Diag*)p->ptr);
		break;
	case SOAP_TYPE___ns2__DiagEx:
		if (p->size < 0)
			SOAP_DELETE((struct __ns2__DiagEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns2__DiagEx*)p->ptr);
		break;
	case SOAP_TYPE___ns3__HelloWorld:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__HelloWorld*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__HelloWorld*)p->ptr);
		break;
	case SOAP_TYPE___ns3__GetVersion:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__GetVersion*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__GetVersion*)p->ptr);
		break;
	case SOAP_TYPE___ns3__GetStatus:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__GetStatus*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__GetStatus*)p->ptr);
		break;
	case SOAP_TYPE___ns3__OpenJob:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__OpenJob*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__OpenJob*)p->ptr);
		break;
	case SOAP_TYPE___ns3__OpenJobEx:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__OpenJobEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__OpenJobEx*)p->ptr);
		break;
	case SOAP_TYPE___ns3__RenewLease:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__RenewLease*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__RenewLease*)p->ptr);
		break;
	case SOAP_TYPE___ns3__Execute:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__Execute*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__Execute*)p->ptr);
		break;
	case SOAP_TYPE___ns3__ExecuteEx:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__ExecuteEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__ExecuteEx*)p->ptr);
		break;
	case SOAP_TYPE___ns3__CloseJob:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__CloseJob*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__CloseJob*)p->ptr);
		break;
	case SOAP_TYPE___ns3__BatchJob:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__BatchJob*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__BatchJob*)p->ptr);
		break;
	case SOAP_TYPE___ns3__BatchJobEx:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__BatchJobEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__BatchJobEx*)p->ptr);
		break;
	case SOAP_TYPE___ns3__GetExpiration:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__GetExpiration*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__GetExpiration*)p->ptr);
		break;
	case SOAP_TYPE___ns3__GetAllJobs:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__GetAllJobs*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__GetAllJobs*)p->ptr);
		break;
	case SOAP_TYPE___ns3__GetAllJobsEx:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__GetAllJobsEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__GetAllJobsEx*)p->ptr);
		break;
	case SOAP_TYPE___ns3__CloseExpiredJobs:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__CloseExpiredJobs*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__CloseExpiredJobs*)p->ptr);
		break;
	case SOAP_TYPE___ns3__CloseAllJobs:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__CloseAllJobs*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__CloseAllJobs*)p->ptr);
		break;
	case SOAP_TYPE___ns3__Diag:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__Diag*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__Diag*)p->ptr);
		break;
	case SOAP_TYPE___ns3__DiagEx:
		if (p->size < 0)
			SOAP_DELETE((struct __ns3__DiagEx*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns3__DiagEx*)p->ptr);
		break;
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
	...
	case SOAP_TYPE_std__vectorTemplateOfPointerTons1__LuaValue:
		if (p->size < 0)
			SOAP_DELETE((std::vector<ns1__LuaValue * >*)p->ptr);
		else
			SOAP_DELETE_ARRAY((std::vector<ns1__LuaValue * >*)p->ptr);
		break;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__LuaType(struct soap *soap, const enum ns1__LuaType *a, const char *tag, const char *type)
{
	...
	if (soap_out_ns1__LuaType(soap, tag?tag:"ns1:LuaType", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
int _ns1__DiagExResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:DiagExResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__DiagExResponse * SOAP_FMAC2 soap_instantiate__ns1__DiagExResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__DiagExResponse);
		if (size)
			*size = sizeof(_ns1__DiagExResponse);
		((_ns1__DiagExResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__DiagExResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__DiagEx::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:DiagEx", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__DiagEx * SOAP_FMAC2 soap_instantiate__ns1__DiagEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__DiagEx);
		if (size)
			*size = sizeof(_ns1__DiagEx);
		((_ns1__DiagEx*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__DiagEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__DiagResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:DiagResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__DiagResponse * SOAP_FMAC2 soap_instantiate__ns1__DiagResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__DiagResponse);
		if (size)
			*size = sizeof(_ns1__DiagResponse);
		((_ns1__DiagResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__DiagResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__Diag::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:Diag", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__Diag * SOAP_FMAC2 soap_instantiate__ns1__Diag(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__Diag);
		if (size)
			*size = sizeof(_ns1__Diag);
		((_ns1__Diag*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__Diag[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__CloseAllJobsResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:CloseAllJobsResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__CloseAllJobsResponse * SOAP_FMAC2 soap_instantiate__ns1__CloseAllJobsResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__CloseAllJobsResponse);
		if (size)
			*size = sizeof(_ns1__CloseAllJobsResponse);
		((_ns1__CloseAllJobsResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__CloseAllJobsResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__CloseAllJobs::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:CloseAllJobs", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__CloseAllJobs * SOAP_FMAC2 soap_instantiate__ns1__CloseAllJobs(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__CloseAllJobs);
		if (size)
			*size = sizeof(_ns1__CloseAllJobs);
		((_ns1__CloseAllJobs*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__CloseAllJobs[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__CloseExpiredJobsResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:CloseExpiredJobsResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__CloseExpiredJobsResponse * SOAP_FMAC2 soap_instantiate__ns1__CloseExpiredJobsResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__CloseExpiredJobsResponse);
		if (size)
			*size = sizeof(_ns1__CloseExpiredJobsResponse);
		((_ns1__CloseExpiredJobsResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__CloseExpiredJobsResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__CloseExpiredJobs::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:CloseExpiredJobs", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__CloseExpiredJobs * SOAP_FMAC2 soap_instantiate__ns1__CloseExpiredJobs(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__CloseExpiredJobs);
		if (size)
			*size = sizeof(_ns1__CloseExpiredJobs);
		((_ns1__CloseExpiredJobs*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__CloseExpiredJobs[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__GetAllJobsExResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:GetAllJobsExResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__GetAllJobsExResponse * SOAP_FMAC2 soap_instantiate__ns1__GetAllJobsExResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetAllJobsExResponse);
		if (size)
			*size = sizeof(_ns1__GetAllJobsExResponse);
		((_ns1__GetAllJobsExResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetAllJobsExResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__GetAllJobsEx::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:GetAllJobsEx", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__GetAllJobsEx * SOAP_FMAC2 soap_instantiate__ns1__GetAllJobsEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetAllJobsEx);
		if (size)
			*size = sizeof(_ns1__GetAllJobsEx);
		((_ns1__GetAllJobsEx*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetAllJobsEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__GetAllJobsResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:GetAllJobsResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__GetAllJobsResponse * SOAP_FMAC2 soap_instantiate__ns1__GetAllJobsResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetAllJobsResponse);
		if (size)
			*size = sizeof(_ns1__GetAllJobsResponse);
		((_ns1__GetAllJobsResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetAllJobsResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__GetAllJobs::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:GetAllJobs", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__GetAllJobs * SOAP_FMAC2 soap_instantiate__ns1__GetAllJobs(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetAllJobs);
		if (size)
			*size = sizeof(_ns1__GetAllJobs);
		((_ns1__GetAllJobs*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetAllJobs[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__GetExpirationResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:GetExpirationResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__GetExpirationResponse * SOAP_FMAC2 soap_instantiate__ns1__GetExpirationResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetExpirationResponse);
		if (size)
			*size = sizeof(_ns1__GetExpirationResponse);
		((_ns1__GetExpirationResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetExpirationResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__GetExpiration::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:GetExpiration", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__GetExpiration * SOAP_FMAC2 soap_instantiate__ns1__GetExpiration(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetExpiration);
		if (size)
			*size = sizeof(_ns1__GetExpiration);
		((_ns1__GetExpiration*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetExpiration[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__BatchJobExResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:BatchJobExResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__BatchJobExResponse * SOAP_FMAC2 soap_instantiate__ns1__BatchJobExResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__BatchJobExResponse);
		if (size)
			*size = sizeof(_ns1__BatchJobExResponse);
		((_ns1__BatchJobExResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__BatchJobExResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__BatchJobEx::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:BatchJobEx", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__BatchJobEx * SOAP_FMAC2 soap_instantiate__ns1__BatchJobEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__BatchJobEx);
		if (size)
			*size = sizeof(_ns1__BatchJobEx);
		((_ns1__BatchJobEx*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__BatchJobEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__BatchJobResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:BatchJobResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__BatchJobResponse * SOAP_FMAC2 soap_instantiate__ns1__BatchJobResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__BatchJobResponse);
		if (size)
			*size = sizeof(_ns1__BatchJobResponse);
		((_ns1__BatchJobResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__BatchJobResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__BatchJob::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:BatchJob", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__BatchJob * SOAP_FMAC2 soap_instantiate__ns1__BatchJob(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__BatchJob);
		if (size)
			*size = sizeof(_ns1__BatchJob);
		((_ns1__BatchJob*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__BatchJob[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__CloseJobResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:CloseJobResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__CloseJobResponse * SOAP_FMAC2 soap_instantiate__ns1__CloseJobResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__CloseJobResponse);
		if (size)
			*size = sizeof(_ns1__CloseJobResponse);
		((_ns1__CloseJobResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__CloseJobResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__CloseJob::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:CloseJob", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__CloseJob * SOAP_FMAC2 soap_instantiate__ns1__CloseJob(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__CloseJob);
		if (size)
			*size = sizeof(_ns1__CloseJob);
		((_ns1__CloseJob*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__CloseJob[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__ExecuteExResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:ExecuteExResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__ExecuteExResponse * SOAP_FMAC2 soap_instantiate__ns1__ExecuteExResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__ExecuteExResponse);
		if (size)
			*size = sizeof(_ns1__ExecuteExResponse);
		((_ns1__ExecuteExResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__ExecuteExResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__ExecuteEx::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:ExecuteEx", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__ExecuteEx * SOAP_FMAC2 soap_instantiate__ns1__ExecuteEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__ExecuteEx);
		if (size)
			*size = sizeof(_ns1__ExecuteEx);
		((_ns1__ExecuteEx*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__ExecuteEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 _ns1__ExecuteResponse * SOAP_FMAC2 soap_instantiate__ns1__ExecuteResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(_ns1__ExecuteResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 _ns1__Execute * SOAP_FMAC2 soap_instantiate__ns1__Execute(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(_ns1__Execute[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__RenewLeaseResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:RenewLeaseResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__RenewLeaseResponse * SOAP_FMAC2 soap_instantiate__ns1__RenewLeaseResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__RenewLeaseResponse);
		if (size)
			*size = sizeof(_ns1__RenewLeaseResponse);
		((_ns1__RenewLeaseResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__RenewLeaseResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__RenewLease::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:RenewLease", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__RenewLease * SOAP_FMAC2 soap_instantiate__ns1__RenewLease(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__RenewLease);
		if (size)
			*size = sizeof(_ns1__RenewLease);
		((_ns1__RenewLease*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__RenewLease[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__OpenJobExResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:OpenJobExResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__OpenJobExResponse * SOAP_FMAC2 soap_instantiate__ns1__OpenJobExResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__OpenJobExResponse);
		if (size)
			*size = sizeof(_ns1__OpenJobExResponse);
		((_ns1__OpenJobExResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__OpenJobExResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__OpenJobResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:OpenJobResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__OpenJobResponse * SOAP_FMAC2 soap_instantiate__ns1__OpenJobResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__OpenJobResponse);
		if (size)
			*size = sizeof(_ns1__OpenJobResponse);
		((_ns1__OpenJobResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__OpenJobResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__OpenJobEx::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:OpenJobEx", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__OpenJobEx * SOAP_FMAC2 soap_instantiate__ns1__OpenJobEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__OpenJobEx);
		if (size)
			*size = sizeof(_ns1__OpenJobEx);
		((_ns1__OpenJobEx*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__OpenJobEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__OpenJob::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:OpenJob", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__OpenJob * SOAP_FMAC2 soap_instantiate__ns1__OpenJob(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__OpenJob);
		if (size)
			*size = sizeof(_ns1__OpenJob);
		((_ns1__OpenJob*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__OpenJob[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 _ns1__GetStatusResponse * SOAP_FMAC2 soap_instantiate__ns1__GetStatusResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetStatusResponse);
		if (size)
			*size = sizeof(_ns1__GetStatusResponse);
		((_ns1__GetStatusResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetStatusResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 _ns1__GetStatus * SOAP_FMAC2 soap_instantiate__ns1__GetStatus(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetStatus);
		if (size)
			*size = sizeof(_ns1__GetStatus);
		((_ns1__GetStatus*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetStatus[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int ns1__LuaValue::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:LuaValue", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 ns1__LuaValue * SOAP_FMAC2 soap_instantiate_ns1__LuaValue(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(ns1__LuaValue);
		if (size)
			*size = sizeof(ns1__LuaValue);
		((ns1__LuaValue*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(ns1__LuaValue[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int ns1__ArrayOfJob::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:ArrayOfJob", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 ns1__ArrayOfJob * SOAP_FMAC2 soap_instantiate_ns1__ArrayOfJob(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(ns1__ArrayOfJob);
		if (size)
			*size = sizeof(ns1__ArrayOfJob);
		((ns1__ArrayOfJob*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(ns1__ArrayOfJob[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int ns1__ArrayOfLuaValue::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:ArrayOfLuaValue", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 ns1__ArrayOfLuaValue * SOAP_FMAC2 soap_instantiate_ns1__ArrayOfLuaValue(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(ns1__ArrayOfLuaValue);
		if (size)
			*size = sizeof(ns1__ArrayOfLuaValue);
		((ns1__ArrayOfLuaValue*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(ns1__ArrayOfLuaValue[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int ns1__ScriptExecution::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:ScriptExecution", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 ns1__ScriptExecution * SOAP_FMAC2 soap_instantiate_ns1__ScriptExecution(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(ns1__ScriptExecution);
		if (size)
			*size = sizeof(ns1__ScriptExecution);
		((ns1__ScriptExecution*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(ns1__ScriptExecution[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 ns1__Job * SOAP_FMAC2 soap_instantiate_ns1__Job(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(ns1__Job[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__DiagEx(soap, tag?tag:"-ns3:DiagEx", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__DiagEx * SOAP_FMAC2 soap_instantiate___ns3__DiagEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__DiagEx);
		if (size)
			*size = sizeof(struct __ns3__DiagEx);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__DiagEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__Diag(soap, tag?tag:"-ns3:Diag", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__Diag * SOAP_FMAC2 soap_instantiate___ns3__Diag(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__Diag);
		if (size)
			*size = sizeof(struct __ns3__Diag);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__Diag[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__CloseAllJobs(soap, tag?tag:"-ns3:CloseAllJobs", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__CloseAllJobs * SOAP_FMAC2 soap_instantiate___ns3__CloseAllJobs(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__CloseAllJobs);
		if (size)
			*size = sizeof(struct __ns3__CloseAllJobs);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__CloseAllJobs[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__CloseExpiredJobs(soap, tag?tag:"-ns3:CloseExpiredJobs", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__CloseExpiredJobs * SOAP_FMAC2 soap_instantiate___ns3__CloseExpiredJobs(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__CloseExpiredJobs);
		if (size)
			*size = sizeof(struct __ns3__CloseExpiredJobs);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__CloseExpiredJobs[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__GetAllJobsEx(soap, tag?tag:"-ns3:GetAllJobsEx", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__GetAllJobsEx * SOAP_FMAC2 soap_instantiate___ns3__GetAllJobsEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__GetAllJobsEx);
		if (size)
			*size = sizeof(struct __ns3__GetAllJobsEx);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__GetAllJobsEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__GetAllJobs(soap, tag?tag:"-ns3:GetAllJobs", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__GetAllJobs * SOAP_FMAC2 soap_instantiate___ns3__GetAllJobs(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__GetAllJobs);
		if (size)
			*size = sizeof(struct __ns3__GetAllJobs);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__GetAllJobs[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__GetExpiration(soap, tag?tag:"-ns3:GetExpiration", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__GetExpiration * SOAP_FMAC2 soap_instantiate___ns3__GetExpiration(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__GetExpiration);
		if (size)
			*size = sizeof(struct __ns3__GetExpiration);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__GetExpiration[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__BatchJobEx(soap, tag?tag:"-ns3:BatchJobEx", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__BatchJobEx * SOAP_FMAC2 soap_instantiate___ns3__BatchJobEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__BatchJobEx);
		if (size)
			*size = sizeof(struct __ns3__BatchJobEx);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__BatchJobEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__BatchJob(soap, tag?tag:"-ns3:BatchJob", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__BatchJob * SOAP_FMAC2 soap_instantiate___ns3__BatchJob(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__BatchJob);
		if (size)
			*size = sizeof(struct __ns3__BatchJob);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__BatchJob[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__CloseJob(soap, tag?tag:"-ns3:CloseJob", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__CloseJob * SOAP_FMAC2 soap_instantiate___ns3__CloseJob(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__CloseJob);
		if (size)
			*size = sizeof(struct __ns3__CloseJob);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__CloseJob[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__ExecuteEx(soap, tag?tag:"-ns3:ExecuteEx", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__ExecuteEx * SOAP_FMAC2 soap_instantiate___ns3__ExecuteEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__ExecuteEx);
		if (size)
			*size = sizeof(struct __ns3__ExecuteEx);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__ExecuteEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__Execute(soap, tag?tag:"-ns3:Execute", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__Execute * SOAP_FMAC2 soap_instantiate___ns3__Execute(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__Execute);
		if (size)
			*size = sizeof(struct __ns3__Execute);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__Execute[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__RenewLease(soap, tag?tag:"-ns3:RenewLease", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__RenewLease * SOAP_FMAC2 soap_instantiate___ns3__RenewLease(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__RenewLease);
		if (size)
			*size = sizeof(struct __ns3__RenewLease);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__RenewLease[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__OpenJobEx(soap, tag?tag:"-ns3:OpenJobEx", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__OpenJobEx * SOAP_FMAC2 soap_instantiate___ns3__OpenJobEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__OpenJobEx);
		if (size)
			*size = sizeof(struct __ns3__OpenJobEx);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__OpenJobEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__OpenJob(soap, tag?tag:"-ns3:OpenJob", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__OpenJob * SOAP_FMAC2 soap_instantiate___ns3__OpenJob(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__OpenJob);
		if (size)
			*size = sizeof(struct __ns3__OpenJob);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__OpenJob[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__GetStatus(soap, tag?tag:"-ns3:GetStatus", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__GetStatus * SOAP_FMAC2 soap_instantiate___ns3__GetStatus(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__GetStatus);
		if (size)
			*size = sizeof(struct __ns3__GetStatus);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__GetStatus[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__GetVersion(soap, tag?tag:"-ns3:GetVersion", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__GetVersion * SOAP_FMAC2 soap_instantiate___ns3__GetVersion(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__GetVersion);
		if (size)
			*size = sizeof(struct __ns3__GetVersion);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__GetVersion[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns3__HelloWorld(soap, tag?tag:"-ns3:HelloWorld", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns3__HelloWorld * SOAP_FMAC2 soap_instantiate___ns3__HelloWorld(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__HelloWorld);
		if (size)
			*size = sizeof(struct __ns3__HelloWorld);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns3__HelloWorld[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__DiagEx(soap, tag?tag:"-ns2:DiagEx", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__DiagEx * SOAP_FMAC2 soap_instantiate___ns2__DiagEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__DiagEx);
		if (size)
			*size = sizeof(struct __ns2__DiagEx);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__DiagEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__Diag(soap, tag?tag:"-ns2:Diag", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__Diag * SOAP_FMAC2 soap_instantiate___ns2__Diag(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__Diag);
		if (size)
			*size = sizeof(struct __ns2__Diag);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__Diag[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__CloseAllJobs(soap, tag?tag:"-ns2:CloseAllJobs", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__CloseAllJobs * SOAP_FMAC2 soap_instantiate___ns2__CloseAllJobs(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__CloseAllJobs);
		if (size)
			*size = sizeof(struct __ns2__CloseAllJobs);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__CloseAllJobs[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__CloseExpiredJobs(soap, tag?tag:"-ns2:CloseExpiredJobs", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__CloseExpiredJobs * SOAP_FMAC2 soap_instantiate___ns2__CloseExpiredJobs(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__CloseExpiredJobs);
		if (size)
			*size = sizeof(struct __ns2__CloseExpiredJobs);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__CloseExpiredJobs[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__GetAllJobsEx(soap, tag?tag:"-ns2:GetAllJobsEx", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__GetAllJobsEx * SOAP_FMAC2 soap_instantiate___ns2__GetAllJobsEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__GetAllJobsEx);
		if (size)
			*size = sizeof(struct __ns2__GetAllJobsEx);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__GetAllJobsEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__GetAllJobs(soap, tag?tag:"-ns2:GetAllJobs", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__GetAllJobs * SOAP_FMAC2 soap_instantiate___ns2__GetAllJobs(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__GetAllJobs);
		if (size)
			*size = sizeof(struct __ns2__GetAllJobs);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__GetAllJobs[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__GetExpiration(soap, tag?tag:"-ns2:GetExpiration", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__GetExpiration * SOAP_FMAC2 soap_instantiate___ns2__GetExpiration(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__GetExpiration);
		if (size)
			*size = sizeof(struct __ns2__GetExpiration);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__GetExpiration[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__BatchJobEx(soap, tag?tag:"-ns2:BatchJobEx", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__BatchJobEx * SOAP_FMAC2 soap_instantiate___ns2__BatchJobEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__BatchJobEx);
		if (size)
			*size = sizeof(struct __ns2__BatchJobEx);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__BatchJobEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__BatchJob(soap, tag?tag:"-ns2:BatchJob", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__BatchJob * SOAP_FMAC2 soap_instantiate___ns2__BatchJob(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__BatchJob);
		if (size)
			*size = sizeof(struct __ns2__BatchJob);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__BatchJob[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__CloseJob(soap, tag?tag:"-ns2:CloseJob", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__CloseJob * SOAP_FMAC2 soap_instantiate___ns2__CloseJob(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__CloseJob);
		if (size)
			*size = sizeof(struct __ns2__CloseJob);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__CloseJob[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__ExecuteEx(soap, tag?tag:"-ns2:ExecuteEx", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__ExecuteEx * SOAP_FMAC2 soap_instantiate___ns2__ExecuteEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__ExecuteEx);
		if (size)
			*size = sizeof(struct __ns2__ExecuteEx);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__ExecuteEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__Execute(soap, tag?tag:"-ns2:Execute", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__Execute * SOAP_FMAC2 soap_instantiate___ns2__Execute(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__Execute);
		if (size)
			*size = sizeof(struct __ns2__Execute);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__Execute[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__RenewLease(soap, tag?tag:"-ns2:RenewLease", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__RenewLease * SOAP_FMAC2 soap_instantiate___ns2__RenewLease(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__RenewLease);
		if (size)
			*size = sizeof(struct __ns2__RenewLease);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__RenewLease[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__OpenJobEx(soap, tag?tag:"-ns2:OpenJobEx", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__OpenJobEx * SOAP_FMAC2 soap_instantiate___ns2__OpenJobEx(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__OpenJobEx);
		if (size)
			*size = sizeof(struct __ns2__OpenJobEx);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__OpenJobEx[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__OpenJob(soap, tag?tag:"-ns2:OpenJob", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__OpenJob * SOAP_FMAC2 soap_instantiate___ns2__OpenJob(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__OpenJob);
		if (size)
			*size = sizeof(struct __ns2__OpenJob);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__OpenJob[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__GetStatus(soap, tag?tag:"-ns2:GetStatus", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__GetStatus * SOAP_FMAC2 soap_instantiate___ns2__GetStatus(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__GetStatus);
		if (size)
			*size = sizeof(struct __ns2__GetStatus);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__GetStatus[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__GetVersion(soap, tag?tag:"-ns2:GetVersion", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__GetVersion * SOAP_FMAC2 soap_instantiate___ns2__GetVersion(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__GetVersion);
		if (size)
			*size = sizeof(struct __ns2__GetVersion);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__GetVersion[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = 0;
	if (soap_out___ns2__HelloWorld(soap, tag?tag:"-ns2:HelloWorld", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns2__HelloWorld * SOAP_FMAC2 soap_instantiate___ns2__HelloWorld(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__HelloWorld);
		if (size)
			*size = sizeof(struct __ns2__HelloWorld);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns2__HelloWorld[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__DiagExResponse(struct soap *soap, _ns1__DiagExResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__DiagExResponse(soap, tag?tag:"ns1:DiagExResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__DiagEx(struct soap *soap, _ns1__DiagEx *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__DiagEx(soap, tag?tag:"ns1:DiagEx", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__DiagResponse(struct soap *soap, _ns1__DiagResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__DiagResponse(soap, tag?tag:"ns1:DiagResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__Diag(struct soap *soap, _ns1__Diag *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__Diag(soap, tag?tag:"ns1:Diag", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__CloseAllJobsResponse(struct soap *soap, _ns1__CloseAllJobsResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__CloseAllJobsResponse(soap, tag?tag:"ns1:CloseAllJobsResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__CloseAllJobs(struct soap *soap, _ns1__CloseAllJobs *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__CloseAllJobs(soap, tag?tag:"ns1:CloseAllJobs", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__CloseExpiredJobsResponse(struct soap *soap, _ns1__CloseExpiredJobsResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__CloseExpiredJobsResponse(soap, tag?tag:"ns1:CloseExpiredJobsResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__CloseExpiredJobs(struct soap *soap, _ns1__CloseExpiredJobs *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__CloseExpiredJobs(soap, tag?tag:"ns1:CloseExpiredJobs", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__GetAllJobsExResponse(struct soap *soap, _ns1__GetAllJobsExResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__GetAllJobsExResponse(soap, tag?tag:"ns1:GetAllJobsExResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__GetAllJobsEx(struct soap *soap, _ns1__GetAllJobsEx *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__GetAllJobsEx(soap, tag?tag:"ns1:GetAllJobsEx", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__GetAllJobsResponse(struct soap *soap, _ns1__GetAllJobsResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__GetAllJobsResponse(soap, tag?tag:"ns1:GetAllJobsResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__GetAllJobs(struct soap *soap, _ns1__GetAllJobs *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__GetAllJobs(soap, tag?tag:"ns1:GetAllJobs", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__GetExpirationResponse(struct soap *soap, _ns1__GetExpirationResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__GetExpirationResponse(soap, tag?tag:"ns1:GetExpirationResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__GetExpiration(struct soap *soap, _ns1__GetExpiration *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__GetExpiration(soap, tag?tag:"ns1:GetExpiration", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__BatchJobExResponse(struct soap *soap, _ns1__BatchJobExResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__BatchJobExResponse(soap, tag?tag:"ns1:BatchJobExResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__BatchJobEx(struct soap *soap, _ns1__BatchJobEx *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__BatchJobEx(soap, tag?tag:"ns1:BatchJobEx", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__BatchJobResponse(struct soap *soap, _ns1__BatchJobResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__BatchJobResponse(soap, tag?tag:"ns1:BatchJobResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__BatchJob(struct soap *soap, _ns1__BatchJob *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__BatchJob(soap, tag?tag:"ns1:BatchJob", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__CloseJobResponse(struct soap *soap, _ns1__CloseJobResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__CloseJobResponse(soap, tag?tag:"ns1:CloseJobResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__CloseJob(struct soap *soap, _ns1__CloseJob *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__CloseJob(soap, tag?tag:"ns1:CloseJob", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__ExecuteExResponse(struct soap *soap, _ns1__ExecuteExResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__ExecuteExResponse(soap, tag?tag:"ns1:ExecuteExResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__ExecuteEx(struct soap *soap, _ns1__ExecuteEx *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__ExecuteEx(soap, tag?tag:"ns1:ExecuteEx", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__RenewLeaseResponse(struct soap *soap, _ns1__RenewLeaseResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__RenewLeaseResponse(soap, tag?tag:"ns1:RenewLeaseResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__RenewLease(struct soap *soap, _ns1__RenewLease *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__RenewLease(soap, tag?tag:"ns1:RenewLease", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__OpenJobExResponse(struct soap *soap, _ns1__OpenJobExResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__OpenJobExResponse(soap, tag?tag:"ns1:OpenJobExResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__OpenJobEx(struct soap *soap, _ns1__OpenJobEx *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__OpenJobEx(soap, tag?tag:"ns1:OpenJobEx", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__OpenJobResponse(struct soap *soap, _ns1__OpenJobResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__OpenJobResponse(soap, tag?tag:"ns1:OpenJobResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__OpenJob(struct soap *soap, _ns1__OpenJob *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__OpenJob(soap, tag?tag:"ns1:OpenJob", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__GetStatusResponse(struct soap *soap, _ns1__GetStatusResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__GetStatusResponse(soap, tag?tag:"ns1:GetStatusResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__GetStatus(struct soap *soap, _ns1__GetStatus *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__GetStatus(soap, tag?tag:"ns1:GetStatus", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons1__ArrayOfJob(struct soap *soap, ns1__ArrayOfJob *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTons1__ArrayOfJob(soap, tag?tag:"ns1:ArrayOfJob", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons1__ScriptExecution(struct soap *soap, ns1__ScriptExecution *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTons1__ScriptExecution(soap, tag?tag:"ns1:ScriptExecution", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons1__LuaValue(struct soap *soap, ns1__LuaValue *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTons1__LuaValue(soap, tag?tag:"ns1:LuaValue", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons1__ArrayOfLuaValue(struct soap *soap, ns1__ArrayOfLuaValue *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTons1__ArrayOfLuaValue(soap, tag?tag:"ns1:ArrayOfLuaValue", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 std::vector<ns1__Job * > * SOAP_FMAC2 soap_instantiate_std__vectorTemplateOfPointerTons1__Job(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(std::vector<ns1__Job * >[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 std::vector<ns1__LuaValue * > * SOAP_FMAC2 soap_instantiate_std__vectorTemplateOfPointerTons1__LuaValue(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(std::vector<ns1__LuaValue * >);
		if (size)
			*size = sizeof(std::vector<ns1__LuaValue * >);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(std::vector<ns1__LuaValue * >[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
